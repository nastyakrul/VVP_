...
int main()
{
    ...
    int n, a[100] = { 0 }, i, i1, i2, min, max, i3; //ввод переменных
    ...
    n++;
    for (i = n; i>=i1; i--) //перед минимальным элемент ставим 0
        a[i] = a[i - 1];
    a[i1] = 0;
    for (i = 1; i <= n; i++)
    {
    ...
    n++;
    for (i3 = n; i3>=i2 + 2; i--) //после максимального элемента ставим 0
        a[i3]  = a[i3 - 1];
    a[i3 + 1] = 0;
    printf("Новый массив :\n");
    for (i = 1; i <= n; i++)
